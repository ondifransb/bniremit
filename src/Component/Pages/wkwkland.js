										...
										>
											{e.beneficiaryCustomers[0].long_name ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].long_name}
												/>
											) : null}
											...
											{e.beneficiaryCustomers[0].sourceoffund ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].sourceoffund}
												/>
											) : null}
										</Grid>
										...
										>
											{e.beneficiaryCustomers[0].resident ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].resident}
												/>
											) : null}
											...
											{e.beneficiaryCustomers[0].datecreate ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].datecreate}
												/>
											) : null}
											...
											{e.beneficiaryCustomers[0].dateupdate ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].dateupdate}
												/>
											) : null}
										</Grid>
										...
										>
											{e.beneficiaryCustomers[0].remitcardno ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].remitcardno}
												/>
											) : null}
											...
											{e.beneficiaryCustomers[0].idtype ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].idtype}
												/>
											) : null}
											...
											{e.beneficiaryCustomers[0].idtypeno ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].idtypeno}
												/>
											) : null}
										</Grid>
										...
										>
											{e.beneficiaryCustomers[0].service_type ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].service_type}
												/>
											) : null}
											...
											{e.beneficiaryCustomers[0].accountnum ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].accountnum}
												/>
											) : null}
										</Grid>
										...
										>
											{e.beneficiaryCustomers[0].trxpurpose ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].trxpurpose}
												/>
											) : null}
											...
											{e.beneficiaryCustomers[0].email ? (
												<TextField
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].email}
												/>
											) : null}

											{e.beneficiaryCustomers[0].status ? (
												<TextField
													fullWidth
													xs={4}
													InputProps={{
													...
													autoFocus
													color="secondary"
													defaultValue={e.beneficiaryCustomers[0].status}
												/>
											) : null}
										</Grid>
									</DialogContent>
			...
			>
				...
				>
					...
					<TextField
						...
						color="secondary"
						defaultValue={
							e.beneficiaryCustomers[0]?.service_type ? "BNI" : null
						}
					/>
	...
	function AllItem({ e, i }) {
		return (
			...
			>
				...
				{OpenIt && e.id == e.id ? <DialogItem e={e} /> : null}
			</Grid>
		);
	}
